...
class FoodRecognizer {
  ...
  FoodRecognizer._privateConstructor() {
    ...
    this.targetPicInfo.addListener(() {
      ...
      FoodRecognizer._sendFoodRecognizeRequest(
          item.bs64, item.byte, item.rotate);
    });
  }
  ...
  static void addFoodPic(String targetPicBase64, Uint8List byte, int rotate) {
    ...
    FoodRecognizer._instance.targetPicInfo
        .value = Queue.from(FoodRecognizer._instance.targetPicInfo.value)
      ..add(new RequestItem(bs64: targetPicBase64, byte: byte, rotate: rotate));
  }
  ...
  static void _sendFoodRecognizeRequest(
      String bs64, Uint8List byte, int rotate) async {
    if (_instance == null) {
      print("Try recognize Food when Recognizer is not init yet");
      return;
    }
    Response res =
        await Requests.foodDetect(null, {"food_b64": bs64, "rotation": rotate});
    if (res == null) {
