...
abstract class MyAnimation<T> implements ValueListenable<T> {
  ...
  MyAnimation() {}
  void initAnimation(T Start, T tweenEnd, int duration, TickerProvider tk,
...
class TweenAnimation<T> implements MyAnimation<T> {
  ...
  List<AnimationStatusListener> statusListenerList =
      new List<AnimationStatusListener>();
  TweenAnimation() : super() {}
  void initAnimation(T tweenStart, T tweenEnd, int duration, TickerProvider tk,
      VoidCallback listener) {
