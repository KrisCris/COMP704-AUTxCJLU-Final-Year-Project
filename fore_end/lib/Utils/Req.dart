...
class Requests {
  static Future<Response> _errorSolve(
      DioError e, BuildContext context, String repeatKey,
      {Map data, String info = "", Function(BuildContext, Map) f}) async {
    String nline = "";
    for (int i = 0; i < 2; i++) {
      nline += "\n";
    }
  ...
  static Future<Response> _postRequest(
      ...
      String url,
      String info,
      Function(BuildContext, Map) f,
      {ResponseSolver responseSolver}) async {
    ...
    try {
      ...
      print(info + " done");
      responseSolver?.assignResponse(res);
      return responseSolver != null ? responseSolver.solve():res;
    } on DioError catch (e) {
      print(info + "solving error...");
      res = await _errorSolve(e, context, interfaceKey,
          info: info, data: data, f: f);
  ...
  static Future<Response> foodDetect(BuildContext context, data) async {
    return _postRequest(
        "detect", context, data, "/food/detect", "food detect接口", foodDetect,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> sendRegisterEmail(BuildContext context, data) async {
    return _postRequest("registerEmail", context, data,
        "/user/send_register_code", "send register email接口", sendRegisterEmail,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }
  ...
  static Future<Response> signUp(BuildContext context, data) async {
    return _postRequest(
        "signUp", context, data, "/user/signup", "signup接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
    // Dio dio = Req.instance;
    // FormData dt = FormData.fromMap(data);
  ...
  static Future<Response> login(BuildContext context, data) async {
    return _postRequest(
        "login", context, data, "/user/login", "login接口", login);
  }

  static Future<Response> getBasicInfo(BuildContext context, data) async {
    return _postRequest("getBasicInfo", context, data, "/user/get_basic_info",
        "getBasicInfo接口", getBasicInfo,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> updateBody(BuildContext context, data) async {
    return _postRequest("updateBody", context, data, "/plan/update_body_info",
        "updateBodyInfo接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> dailyMeal(BuildContext context, data) async {
    return _postRequest("dailyMeal", context, data,
        "/food/get_daily_consumption", "get_daily_consumption接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> historyMeal(BuildContext context, data) async {
    return _postRequest("historyMeal", context, data,
        "/food/get_consume_history", "get_consume_history接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> recommandFood(BuildContext context, data) async {
    return _postRequest("recommandFood", context, data, "/food/recmd_food",
        "recmd_food接口", recommandFood,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }
  ...
  static Future<Response> setPlan(BuildContext context, data) async {
    return _postRequest(
        "setPlan", context, data, "/plan/set_plan", "setPlan接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> finishPlan(BuildContext context, data) async {
    return _postRequest(
        "finishPlan", context, data, "/plan/finish_plan", "finishPlan接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> getPlan(BuildContext context, data) async {
    return _postRequest("getPlan", context, data, "/plan/get_current_plan",
        "get_current_Plan接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> consumeFoods(BuildContext context, data) async {
    return _postRequest("consumeFoods", context, data, "/food/consume_foods",
        "consume_foods接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> modifyBasicInfo(BuildContext context, data) async {
    return _postRequest("modifyBasicInfo", context, data,
        "/user/modify_basic_info", "modify_basic_info接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> shouldUpdateWeight(BuildContext context, data) async {
    return _postRequest("shouldUpdateWeight", context, data,
        "/plan/should_update_weight", "should_update_weight接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> delayPlan(BuildContext context, data) async {
    return _postRequest(
        "delayPlan", context, data, "/plan/extend_plan", "extend_plan接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> delayAndUpdatePlan(BuildContext context, data) async {
    return _postRequest("delayAndUpdatePlan", context, data,
        "/plan/extend_update_plan", "extend_update_plan接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> calculateDelayTime(BuildContext context, data) async {
    return _postRequest("calculateDelayTime", context, data,
        "/plan/estimate_extension", "estimate_extension接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> getWeightTrend(BuildContext context, data) async {
    return _postRequest("get_weight_trend", context, data,
        "/plan/get_weight_trend", "get_weight_trend接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> getHistoryPlan(BuildContext context, data) async {
    return _postRequest("getHistoryPlan", context, data, "/plan/get_past_plans",
        "get_past_plans接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }

  static Future<Response> setMealIntakeRatio(BuildContext context, data) async {
    return _postRequest("setMealIntakeRatio", context, data,
        "/user/set_meals_intake_ratio", "set_meals_intake接口", null,
        responseSolver: ConnlostSolver(solver: LoginSolver(context)));
  }
  ...
  static Future<Response> checkEmailRepeat(
  ...
  static Future<Response> getCaloriesIntake(BuildContext context, data) async {
    return _postRequest("getCaloriesIntake", context, data,
        "/food/listed_calories_intake", "getCaloriesIntake接口", null);
  }
...
abstract class ResponseSolver {
  int solveCode;
  Response response;
  Response solve();
  void assignResponse(Response res);
}

abstract class NestedResponseSolver extends ResponseSolver {
  ResponseSolver solver;
  NestedResponseSolver({ResponseSolver solver, Response res}) {
    if (res == null) {
      this.solver = solver;
      this.response = this.solver?.response;
    } else {
      this.response = res;
    }
  }
  ...
  void assignResponse(Response res) {
    this.response = res;
    this.solver?.assignResponse(res);
  }
}

class LoginSolver extends NestedResponseSolver {
  BuildContext context;
  LoginSolver(BuildContext context, {NestedResponseSolver solver, Response res})
      : super(solver: solver, res: res) {
...
class ConnlostSolver extends NestedResponseSolver {
  ConnlostSolver({ResponseSolver solver, Response res})
      : super(solver: solver, res: res) {
    this.response = solver.response;
  }
