...
import 'package:fore_end/Models/Meal.dart';
...
import 'package:fore_end/Components/widgets/NutritionBox.dart';
import 'package:fore_end/Components/widgets/basic/PersentBar.dart';
import 'package:fore_end/Components/widgets/food/RecommendBox.dart';
import 'package:fore_end/Components/widgets/food/ValueAdjuster.dart';
...
class _FoodDetailsState extends State<FoodDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    ValueAdjuster a = ValueAdjuster<double>(
        initValue: 10.0, valueWeight: 10.0, key: this.widget.valueAdjusterKey);
    a.onValueChange = () {
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Container(
                ...
                child: Image.memory(
                  base64.decode(widget.currentFood.picture),
                  height: 50,
                  width: 50,
                  fit: BoxFit.fitWidth,
                ...
                child: Column(
                  ...
                  children: [
                    PersentBar(
                        ...
                        sections: [
                          PersentSection(
                            normalColor: const Color(0xff09edfe),

                            ///碳水
                            persent: this
                                .widget
                                .currentFood
                                .calculateThreeNutritionPercent("carbohydrate"),
                          ...
                          PersentSection(
                            ...
                            persent: this
                                .widget
                                .currentFood
                                .calculateThreeNutritionPercent("fat"),
                          ...
                          PersentSection(
                            ...
                            persent: this
                                .widget
                                .currentFood
                                .calculateThreeNutritionPercent("protein"),
                        ...
                        children: [
                          NutritionBox(
                            ...
                            value: NumUtil.getNumByValueDouble(
                                widget.currentFood.calorie *
                                    this.widget.foodWeight /
                                    100,
                                2),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [this.getValueAdjuster()],
                    ),
                    SizedBox(
                      height: 15,
                    )
  ...
  Widget getValueAdjuster() {
    ValueAdjuster valueAdjuster = ValueAdjuster<int>(
      ...
      initValue: this.widget.foodWeight,
      valueWeight: 10,
      ...
      switch (i) {
        case 0:
          {
            return PieChartSectionData(
              ...
              title:
                  (calculatePercent('carbohydrate') * 100).floor().toString() +
                      '%',
              radius: radius,
        ...
        case 1:
          return PieChartSectionData(
            ...
            title:
                (calculatePercent('fat') * 100).floor().toString().toString() +
                    '%',
            radius: radius,
            titleStyle: TextStyle(
                fontSize: fontSize,
        ...
        case 2:
          return PieChartSectionData(
            ...
            title: (calculatePercent('protein') * 100)
                    .floor()
                    .toString()
                    .toString() +
                '%',
        ...
        case 3:
          ...
          return PieChartSectionData(
            ...
            title: this.widget.currentFood.cellulose > 0
                ? (calculatePercent('cellulose') * 100)
                        .floor()
                        .toString()
                        .toString() +
                    '%'
          ...
          return PieChartSectionData(
            ...
            title:
                ...
                this.widget.currentFood.cholesterol > 0
                    ? (calculatePercent('cholesterol') * 100)
                            .floor()
                            .toString()
                            .toString() +
                        '%'
