...
import 'package:fore_end/Components/clipper/DownTopClipper.dart';
import 'package:fore_end/Components/clipper/TopDownClipper.dart';
...
class ExpandListViewState extends State<ExpandListView>
  ...
  void initState() {
    ...
    if (widget.isOpen.value) {
      this
          .clipAnimation
          .initAnimation(widget.height, 0.0, widget.animationTime, this, () {
        setState(() {});
      });
      ...
      this
          .clipAnimation
          .initAnimation(0.0, widget.height, widget.animationTime, this, () {
        setState(() {});
      });
      this.activateClipper = 0;
    }
    print("clip animation initialize state: dismissed = " +
        this.clipAnimation.isDismissed().toString());
    ...
    this.clipAnimation.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        ...
        if (this.activateClipper == 1) {
          this.clipAnimation.initAnimation(
              widget.height, 0.0, widget.animationTime, this, () {
            setState(() {});
          });
        } else {
          this.clipAnimation.initAnimation(
              0.0, widget.height, widget.animationTime, this, () {
            setState(() {});
          });
        }
        this.setState(() {});
  ...
  Widget build(BuildContext context) {
    return ClipRect(
      clipper: this.activateClipper == 0
          ? TopDownClipper(clipAnimation.value)
          : DownTopClipper(clipAnimation.value),
      child: Container(
          width: widget.width,
