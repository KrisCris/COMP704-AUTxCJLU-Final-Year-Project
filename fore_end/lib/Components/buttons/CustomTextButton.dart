...
class CustomTextButtonState extends State<CustomTextButton>
  ...
  @override
  void setEnabled() {
    this.animation.initAnimation(MyTheme.convert(ThemeColorName.DisableText),
        widget.textColor, widget.colorChangeDura, this, () {
      setState(() {});
    });
    this.animation.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
