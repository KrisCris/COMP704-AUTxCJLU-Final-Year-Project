...
class ValueBarBackgroundPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Rect minusRect = Rect.fromLTWH(-ValueBar.buttonSize - ValueBar.buttonGap, 0,
        ValueBar.buttonSize, size.height);
    Rect addRect = Rect.fromLTWH(
        size.width + ValueBar.buttonGap, 0, ValueBar.buttonSize, size.height);
    ...
    if (this.showAdjustButton) {
      ...
      minusPainter.paint(
          canvas,
          Offset(
              -ValueBar.buttonSize - ValueBar.buttonGap + extraHor, extraVer));
      extraHor = (ValueBar.buttonSize - addPainter.width) / 2;
      extraVer = (size.height - addPainter.height) / 2;
      addPainter.paint(
          canvas, Offset(size.width + ValueBar.buttonGap + extraHor, extraVer));
    ...
    if (this.showNumber) {
      ...
      Rect numberRect = Rect.fromLTWH(borderStartX, -20, borderWidth, 20);
