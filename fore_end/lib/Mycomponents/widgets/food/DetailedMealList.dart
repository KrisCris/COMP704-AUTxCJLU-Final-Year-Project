...
class DetailedMealListState extends State<DetailedMealList>{
  ...
  Widget build(BuildContext context) {
    ...
    String calories = "";
    String protein = "";
    String clickHint = this.widget.meal.foods.length == 0 ? CustomLocalizations.of(context).noFoodSearch:"Click Picture for Details" ;
    if(this.detailFood != null){
      foodName = this.detailFood.getName(context) + "  " + this.detailFood.weight.toString()+"g";
      calories = CustomLocalizations.of(context).calories +"  "+ this.detailFood.getCalories().toString()+"Kcal";
      protein = CustomLocalizations.of(context).protein +"  "+this.detailFood.getProtein().toString()+'g';
    }
    return Container(
              ...
              Expanded(child: Column(
                ...
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text(CustomLocalizations.of(context).getContent(this.widget.meal.mealName),style: TextStyle(
                          fontSize: 16,
                      ...
                      Text(CustomLocalizations.of(context).total+" "+
                          this.widget.meal.calculateTotalCalories().toString()+" KCal",style: TextStyle(
                          fontSize: 16,
                          color: MyTheme.convert(ThemeColorName.HeaderText),
                          fontFamily: "Futura",
                          decoration: TextDecoration.none,
                  ...
                  Container(
                    ...
                    child: AnimatedCrossFade(
                        firstChild: Text(clickHint,style: TextStyle(
                            fontFamily: "Futura",
                            fontWeight: FontWeight.bold,
                        ...
                        crossFadeState: this.detailFood == null?CrossFadeState.showFirst:CrossFadeState.showSecond,
